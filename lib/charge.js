  ...
  redis.zrangebyscore(rkey(),
    ...
    function(err, obj) {
      obj.forEach(function(e) {
        ...
        redis.zremrangebyscore(rkey(), charge.charge_at,
          charge.charge_at,
          function(err, obj) {
            redis.zadd(rkey(), charge.charge_at, JSON.stringify(charge),
...
var list = function(res, user_id) {
  redis.zrangebyscore(rkey(), Date.now(), "inf", function(err, obj) {
    var message = "";
    obj.forEach(function(e) {
      var charge = JSON.parse(e);
