...
var DmFacet = function(makeAPICall) {
    this.name = 'dm';
 ...
 */
DmFacet.prototype.close = function(channel, opt_cb) {
    var args = {
        channel: channel
    };
 ...
 * @param {function} opt_cb Optional callback, if not using promises.
 */
DmFacet.prototype.history = function(channel, opts, opt_cb) {
    var args = {
        channel: channel,
        opts: opts
    };
 ...
 * @param {function} opt_cb Optional callback, if not using promises.
 */
DmFacet.prototype.list = function(opt_cb) {
 ...
 * @param {function} opt_cb Optional callback, if not using promises.
 */
DmFacet.prototype.mark = function(channel, ts, opt_cb) {
    var args = {
        channel: channel,
        ts: ts
    };
 ...
 * @param {function} opt_cb Optional callback, if not using promises.
 */
DmFacet.prototype.open = function(user, opt_cb) {
    var args = {
        user: user
    };
