    ...
    describe('Parsed Events', function() {
        ...
        describe('channel, group and DM events', function() {
            ...
            var testBaseChannelLeft = function(event, baseChannelId, expectedUserId) {
                ...
                clientEventHandlers[event](ALICE_USER_ID, '', dataStore, getRTMMessageFixture(event));
                var baseChannel = dataStore.getChannelGroupOrDMById(baseChannelId);
            ...
            describe('`group_xxx` events', function() {
                ...
                it('sets isArchived to false on a group when a `group_unarchive` message is received', function() {
                ...
                it('creates a new group object and replaces the old one when a `group_joined` message is received', function() {
                ...
                describe('`group_left`', function() {
                    ...
                    it('marks the group as archived when the last user leaves', function() {
                        ...
                        expect(group.isArchived).to.be.true;
                    });
                });
        ...
        describe('message events', function() {
            ...
            var testMessageAdd = function(event, baseChannelId, expectedSubtype) {
                var dataStore = getMemoryDataStore();
                clientEventHandlers['message::rtm_client_add_message'](dataStore, getRTMMessageFixture(event));
                var baseChannel = dataStore.getChannelGroupOrDMById(baseChannelId);
            ...
            it('adds an item to message history when a message with no custom handler is received', function() {
